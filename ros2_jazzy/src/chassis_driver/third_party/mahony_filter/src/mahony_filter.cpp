...
static void Quaternion_Solution(Imu_Quaternion* quaternion, float gx, float gy, float gz, float ax, float ay, float az)
{
    float recipNorm;
...
{
    Quaternion_Solution(  quaternion,  gx,  gy,  gz,  ax,  ay,  az);
}