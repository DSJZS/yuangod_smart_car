...
/* user add */
/* 参考: https://github.com/espressif/esp-bsp/blob/master/SquareLine/boards/v8/custom_waveshare_7inch/components/ws_7inch/include/bsp/ws_7inch.h#L89*/
/* 额外添加，用于支持配套4.4版本的i2c初始化 */
typedef struct {
    i2c_port_t port;
    int sda_io_num;      /*!< GPIO number for I2C sda signal */
    int scl_io_num;      /*!< GPIO number for I2C scl signal */
} mpu6050_i2c_config_t;
 ...
 *
 * @param port 不再只是I2C port number, 还包含引脚号
 ...
 *     - Others Success
 */
mpu6050_handle_t mpu6050_create( mpu6050_i2c_config_t* port, const uint16_t dev_addr);
